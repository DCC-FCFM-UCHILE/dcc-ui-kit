# DCC UI Kit 2.5.0 — guía de consumo
...
```
https://cdn.dcc.uchile.cl/ui-kit/2.5.0/
...
nunca más. Así una app puede quedarse en `1.0.0` mientras otra pasa a `2.5.0`, y nadie se rompe por
...
```html
<link rel="stylesheet" href="https://cdn.dcc.uchile.cl/ui-kit/2.5.0/dcc-ui.min.css">
<script src="https://cdn.dcc.uchile.cl/ui-kit/2.5.0/dcc-ui.bundle.min.js" defer></script>
```
...
```html
<link rel="stylesheet"
      href="https://cdn.dcc.uchile.cl/ui-kit/2.5.0/dcc-ui.min.css"
      integrity="sha384-…"
      crossorigin="anonymous">
<script src="https://cdn.dcc.uchile.cl/ui-kit/2.5.0/dcc-ui.bundle.min.js"
        integrity="sha384-…"
...
Para actualizar, cambias `2.5.0` por la versión nueva en esas dos líneas del `base.html`. Nada más.
...
```
https://cdn.dcc.uchile.cl/ui-kit/2.5.0/assets/logo-dcc.svg
https://cdn.dcc.uchile.cl/ui-kit/2.5.0/assets/logo-uchile.svg
https://cdn.dcc.uchile.cl/ui-kit/2.5.0/assets/logo-fcfm.svg
https://cdn.dcc.uchile.cl/ui-kit/2.5.0/assets/logo-cna.svg
```

```html
<img src="https://cdn.dcc.uchile.cl/ui-kit/2.5.0/assets/logo-dcc.svg"
